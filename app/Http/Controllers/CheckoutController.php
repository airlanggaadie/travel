...
class CheckoutController extends Controller
{
    ...
    {
        $item = Transaction::with(['detail','travelpackage','user'])->findOrFail($id);
    ...
    public function remove(Request $request, $detail_id)
    {
        ...
        $transaction = Transaction::with(['detail','travelpackage'])->findOrfail($item->transactions_id);
