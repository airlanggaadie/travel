...
@section('content')
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center section-popular-heading">
                        <h2 style="color: black;">Wisata Popular</h2>
                        <p style="color: black;">
        ...
        <section class="section-popular-content" id="popularContent">
            <div class="container">
                <div class="section-popular-travel row justify-content-center">
                    ...
                    <div class="card-travel text-center d-flex flex-column" style="background-image: url('frontend/images/travel-1.jpeg');">
                    ...
                    <div
                        ...
                        style="background-image: url('frontend/images/travel-2.jpeg');"
                    >
                        <div class="travel-country">INDONESIA</div>
                    ...
                    >
                        ...
                        <div class="travel-button mt-auto">
                        <a href="{{route('checkout')}}" class="btn btn-travel-details px-4">
                            View Details
                        </a>
                        </div>
                    </div>
        ...
        <section class="section-networks bg-secondary" id="networks">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                    <h2>Our Networks</h2>
        ...
        <section class="section-testimonials-heading" id="testimonialsHeading">
            <div class="container">
                <div class="row">
                    ...
                    <h2 style="color:black;">They Are Loving Us</h2>
                    <p style="color:black;">
        ...
        <section class="section-testimonials-content" id="testimonialsContent">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <a href="{{ route('home') }}" class="btn btn-need-help px-4 mt-4 mx-1">
                        I Need Help
                    </a>
