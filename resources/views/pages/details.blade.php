                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <table class="trip-informations">
                            ...
                            <td width="50%" class="text-right" style="color:black;">22 Aug, 2019</td>
                            </tr>
                            <tr>
                            <th width="50%" style="color:black;">Duration</th>
                            <td width="50%" class="text-right" style="color:black;">4D 3N</td>
                            </tr>
                            <tr>
                            <th width="50%" style="color:black;">Type</th>
                            <td width="50%" class="text-right" style="color:black;">Open Trip</td>
                            </tr>
                            <tr>
                        ...
                        <a href="checkout.html" style="color:black;" class="btn btn-block btn-join-now mt-3 py-2"
                            >Join Now</a
                        >
                        </div>
                    </div>
